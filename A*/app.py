...
icon = pygame.image.load(os.path.join(filepath, "food.png"))
pygame.display.set_icon(icon)
filepath = os.path.dirname(__file__)
img = pygame.image.load(os.path.join(filepath, "snakehead.png"))
filepath = os.path.dirname(__file__)
img2 = pygame.image.load(os.path.join(filepath, "food.png"))
pygame.display.flip()
